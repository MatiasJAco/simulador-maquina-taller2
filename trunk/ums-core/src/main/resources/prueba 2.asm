...
ldm 3,FD	# se carga el 3er patron de bits
ldm 4,FD	# se carga el 4to patron de bits

# agrupandose: 1er numero -> (1 2)	2do numero -> (3 4)
# 2 y 4 son las mitades menos significativas del numero (1 2) y (3 4)  
...
and 8,2,7	# el registro 8 contiene ahora el 1er bit  
...
and 12,13,14	# si 12 contiene un 8, se hicieron 8 rotaciones y no salta mas
jpz 12,tag_inicio

# hasta aqui el registro 11 contiene la suma de las partes menos significativas
# y el registro 5 contiene el carry de la suma

# se sumas las partes mas significativas con el carry usando suma complemento a 2

ldi 10,00	# el registro 10 vale 0, contendra la suma de las mitades mas significativas
...
# se escriben en la pantalla, 1ro la mitad mmas significativa despues la menos significativa
stm 10,FF
stm 11,FF
