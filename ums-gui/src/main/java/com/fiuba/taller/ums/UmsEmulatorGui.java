...
public class UmsEmulatorGui {
	...
	private void initialize() {
		...
		frame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				...
				frame.getContentPane().setLayout(gridBagLayout);
						...
						//TODO: BORRAR, ES SOLO PARA PRUEBAS, hay que obtener la cantidad de registros que tiene el emulador
						List<Cell> registryList = new ArrayList();
						
						for (int i = 0 ; i < 16 ; i++){
							registryList.add(new Cell());
						}
						
						//TODO: BORRAR, ES SOLO PARA PRUEBAS, hay que obtener la cantidad de registros que tiene el emulador
						List<Cell> memoryList = new ArrayList();
						
						for (int i = 0 ; i < 256 ; i++){
							memoryList.add(new Cell());
						}
						
						// --- <REGISTRY> ---		
						GridPanel registryPanel = new GridPanel("Registry", registryList, 4, false);
						...
						GridPanel memoryPanel = new GridPanel("Memory", registryList,
								4, true);
	...
	private void initCPUPanel() {
		...
		gbl_aluPanel.columnWeights = new double[]{0.0, 1.0, 0.0, 0.0, 1.0, Double.MIN_VALUE};
